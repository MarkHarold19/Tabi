            ...
            child: Column(
              ...
              children: [
                ScaleTransition(
                  ...
                  child: Image.asset(
                    'assets/logo_1.png', // Make sure to add your image to assets
                    width: 150,
                    height: 150,
                  ),
                ),
...
// Main Dashboard UI with functional elements
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _swapLanguages() {
    setState(() {
      ...
      _toLanguage = temp;
      _translatedText = ''; // Clear translation when languages are swapped
    });
  }
      ...
      body: SafeArea(
        child: Padding(
          padding: EdgeInsets.symmetric(
            ...
            vertical: isPortrait ? screenSize.height * 0.02 : 0,
          ),
          child: Column(
            children: [
              ...
              Expanded(
                flex: isPortrait ? 0 : 1,
                child: _buildInputCard(context, screenSize),
              ),
              ...
              if (!isPortrait) SizedBox(height: screenSize.height * 0.03),
              _buildBottomBar(context, isPortrait),
              if (!isPortrait) SizedBox(height: screenSize.height * 0.02),
            ],
          ),
        ),
      ),
  ...
  Widget _buildBottomBar(BuildContext context, bool isPortrait) {
    final theme = Theme.of(context);
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                fontSize: 24,
                color: theme
                    .textTheme.bodyLarge?.color, // Use theme color for flag
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                color: theme
                    .textTheme.bodyLarge?.color, // Use theme color for text
                fontSize: 16,
...
class _BottomMic extends StatelessWidget {
  final VoidCallback? onPressed;
